...
`AGENTS.md` in the repository root is the single source of truth for project-specific agent rules.

Before performing any repository task, read and follow `AGENTS.md` in full. This includes, but is not limited to:
- emoji boundaries for human-facing versus internal/system output,
- branch and Conventional Commit naming,
