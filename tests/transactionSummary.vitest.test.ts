...
describe('Transaction Summary & Breakdown Tests (Issue #103)', () => {
  beforeEach(() => {
  ...
  describe('Suite 1: Aggregates totals across paginated history and excludes transfers', () => {
    it('verifies pagination, totals, transfer exclusion, and category breakdown', async () => {
